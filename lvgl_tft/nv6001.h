...
#define MOSI_PIN CONFIG_LV_DISP_SPI_MOSI
#define SCK_PIN CONFIG_LV_DISP_SPI_CLK

#define COL CONFIG_LV_VER_RES_MAX // x ↑
#define ROW CONFIG_LV_HOR_RES_MAX // y →
...
#define DISPLAY_ORIENTATION CONFIG_LV_DISPLAY_ORIENTATION
    ...
    */
    ...
    void write_line(int ypos, uint8_t color);
